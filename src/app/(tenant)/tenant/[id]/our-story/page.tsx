        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="md:order-2">
            ...
            <p className="text-lg leading-relaxed mb-4">
              ...
              and said, "This is the exact spot where you asked me to be your
              girlfriend." In that instant, he gently took both of my hands, and
              I immediately knew. He was proposing. My heart raced, time stood
