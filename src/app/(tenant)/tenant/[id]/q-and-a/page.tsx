  ...
  const faqs = [
    ...
    },
    {
      ...
      dangerouslySetInnerHTML: {
        __html: `
        Kindly RSVP by clicking <a href="/#rsvp" class="underline cursor-pointer">here</a> or by reaching out to the bride and groom directly.
          `,
      },
    },
    {
    ...
    //   answer:
    //     "We recommend using ride-sharing services or designated drivers. Check our Travel page for more transportation options.",
    // },
    {
    ...
    //   answer:
    //     "Please let us know about any dietary restrictions when you RSVP, and we'll make sure our caterer can accommodate your needs.",
    // },
    {
        ...
        <div className="space-y-8 mb-20">
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-gray-300 pb-6">
              ...
              {faq?.dangerouslySetInnerHTML && (
                <p
                  className="text-lg leading-relaxed text-gray-700"
                  dangerouslySetInnerHTML={faq.dangerouslySetInnerHTML}
                />
              )}
            </div>
          ))}
