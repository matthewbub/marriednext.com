...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        primary:
          "bg-wedding-accent text-white uppercase tracking-widest hover:bg-wedding-accent/90 transition-colors",
        secondary:
          "bg-stone-100 text-stone-800 uppercase tracking-widest hover:bg-stone-200 transition-colors border border-stone-200",
        outline:
          "border-2 border-wedding-accent text-wedding-accent uppercase tracking-widest hover:bg-wedding-accent hover:text-white transition-colors",
        default:
      ...
      size: {
        ...
        default: "text-base px-6 py-3 rounded",
